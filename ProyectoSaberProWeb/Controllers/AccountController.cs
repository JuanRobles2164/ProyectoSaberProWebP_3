...
namespace ProyectoSaberProWeb.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var ciudadesList = consultarCiudades();
            var departamentosList = consultarDepartamentos();
        ...
        {
               /**
                * Se adapta el método para poder ser usado, tanto por un admin logeado como 
            ...
            ViewBag.Departamentos = consultarDepartamentos();
            ViewBag.Ciudades = consultarCiudades();
        ...
        public List<SelectListItem> consultarDepartamentos()
        {
            ...
            foreach (var departamento in db.departamentos)
            {
                listaDepartamentos.Add(new SelectListItem() { Value = departamento.ID.ToString(), Text = departamento.Nombre });
            }
            return listaDepartamentos;
        }
        public List<SelectListItem> consultarCiudades()
        {
            List<SelectListItem> listaCiudades = new List<SelectListItem>();
            foreach (var ciudad in db.ciudades)
            {
                listaCiudades.Add(new SelectListItem() { Value = ciudad.ID.ToString(), Text = ciudad.Nombre });
            }
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ...
                    ViewBag.Departamentos = this.consultarDepartamentos();
                    ViewBag.Ciudades = this.consultarCiudades();
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { 
                    UserName = model.Email, 
                    Email = model.Email, 
                    Ciudad_Id = int.Parse(model.Ciudad),
                    Nombres = model.Nombres,
                    Apellidos = model.Apellidos,
                };
